...
thresh1 = multithresh(enhanced_img1,2);
% valuesMax1 = [thresh1 max(enhanced_img1(:))];
[quant_spot1, index] = imquantize(enhanced_img1,thresh1);
segmented_img1 = makeBinary(quant_spot1,0.64);

%Norm image 2
enhanced_img2 = imageEnhancement(norm_img2);
thresh2 = multithresh(enhanced_img2,2);
% valuesMax2 = [thresh2 max(enhanced_img2(:))];
[quant_spot2, index] = imquantize(enhanced_img2,thresh2);
segmented_img2 = makeBinary(quant_spot2,0.64);
